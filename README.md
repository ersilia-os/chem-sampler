...
| StonedSampler | The [STONED algorithm](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8153210/) uses SELFIES representations of SMILES to perform searches in the chemical space. |
...
| FasmifraSampler | It does molecule generation based on the Fast Assembly of (Deep)SMILES fragments  [(FasmiFra)](https://jcheminf.biomedcentral.com/articles/10.1186/s13321-021-00566-4) algorithm.*|
| MolibSampler | Geenrates new molecules based on [deep learning approach](https://chemrxiv.org/engage/api-gateway/chemrxiv/assets/orp/resource/item/60c745b8ee301c543bc79391/original/generating-customized-compound-libraries-for-drug-discovery-with-machine-intelligence.pdf) developed by ETH mod lab. The deep learning approach is available as open source at [ETHmodlab/vitual_libraries](https://github.com/ETHmodlab/virtual_libraries) * |
