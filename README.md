...
| SmallWorldSampler | SmallWorld is an index of chemical space containing more than 230B molecular substructures. SmallWorldSampler uses the [Small World API](https://pypi.org/project/smallworld-api/) to post a query to the SmallWorld server |
