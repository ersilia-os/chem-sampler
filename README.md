...
| MolibSampler | It genrates new molecules based on [deep learning approach](https://chemrxiv.org/engage/api-gateway/chemrxiv/assets/orp/resource/item/60c745b8ee301c543bc79391/original/generating-customized-compound-libraries-for-drug-discovery-with-machine-intelligence.pdf) developed by ETH mod lab. The deep learning approach is available as open source at [ETHmodlab/vitual_libraries](https://github.com/ETHmodlab/virtual_libraries).* |
...
Note: you can run all the samplers(except molib and fashmifra) and concat the result into a csv file using 
