...
class MolerFit:
    def __init__(self):
        ...
        self.CHECKPOINT_PATH = os.path.join(root,"molecule_generation", "MODEL_DIR","GNN_Edge_MLP_MoLeR__2022-02-24_07-16-23_best.pkl"  )
    ...
    def input_split(self, smiles_list):
        ...
        train_df, test_df, val_df = np.split(df.iloc[indices], [train_size, train_size+test_size])
